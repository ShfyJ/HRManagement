...
namespace HRManagement.Data.Migrations
{
    ...
    [Migration("20210505044412_NewChangesToStructure")]
    partial class NewChangesToStructure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRManagement.Models.DeputyMembership", b =>
                {
                    b.Property<int>("DeputyMembershipId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);

                    b.Property<string>("DeputyMembershipName")
                        .HasColumnType("text");

                    b.Property<bool>("Status")
                        .HasColumnType("boolean");

                    b.HasKey("DeputyMembershipId");

                    b.ToTable("DeputyMemberships");
                });
            ...
            modelBuilder.Entity("HRManagement.Models.UserBusinessTrips", b =>
                {
                    ...
                    b.HasKey("EmployeeId", "BusinessTripId");

                    b.HasIndex("BusinessTripId");

                    b.ToTable("UserBusinessTrips");
                });
            ...
            modelBuilder.Entity("HRManagement.Data.Models.Auth.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("FullBirthAddress")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HRManagement.Models.Education", b =>
                {
                    ...
                    b.HasOne("HRManagement.Data.Models.Auth.ApplicationUser", "User")
                        .WithMany("Educations")
            ...
            modelBuilder.Entity("HRManagement.Models.EmployeeDisciplinaryAction", b =>
                {
                    ...
                    b.HasOne("HRManagement.Data.Models.Auth.ApplicationUser", "Employee")
            ...
            modelBuilder.Entity("HRManagement.Models.Language", b =>
                {
                    b.HasOne("HRManagement.Data.Models.Auth.ApplicationUser", "ApplicationUser")
                        .WithMany("Languages")
            ...
            modelBuilder.Entity("HRManagement.Models.UserBusinessTrips", b =>
                {
                    b.HasOne("HRManagement.Models.BusinessTrip", "BusinessTrip")
                        .WithMany("UserBusinessTrips")
            ...
            modelBuilder.Entity("HRManagement.Data.Models.Auth.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("HRManagement.Models.Region", "BirthRegion")
                        .WithMany()
                        .HasForeignKey("BirthRegionId");

                    b.HasOne("HRManagement.Models.Country", "CurrentCountry")
                        .WithMany()
                        .HasForeignKey("CurrentCountryId");

                    b.HasOne("HRManagement.Models.District", "CurrentDistrict")
                        .WithMany()
                        .HasForeignKey("CurrentDistrictId");

                    b.HasOne("HRManagement.Models.Region", "CurrentRegion")
                        .WithMany()
                        .HasForeignKey("CurrentRegionId");

                    b.HasOne("HRManagement.Models.DeputyMembership", "DeputyMembership")
                        .WithMany()
                        .HasForeignKey("DeputyMembershipId");
            ...
            modelBuilder.Entity("HRManagement.Models.BusinessTrip", b =>
                {
                    b.Navigation("UserBusinessTrips");
                });
