...
<div>
        <v-card class="mt-5" :elevation="4">
                <v-toolbar align="center" flat>
                    <v-toolbar-title>Mamlakat qo'shish</v-toolbar-title>
                </v-toolbar>
            <v-container
                id="user-profile"
                fluid
...
import axios from "axios"
  export default {
    data: () => ({
      ...
      headers: [
          ...
          { text: 'Mamlakat nomi', value: 'countryName' },
  ...
  methods: {
          editItem (item) {
        this.editedIndex = this.getCountry.indexOf(item)
    ...
    closeDelete () {
      ...
      save () {
        if (this.editedIndex > -1) {
          Object.assign(this.getCountry[this.editedIndex], this.editedItem)
          axios
          ...
          this.getCountry.push(this.editedItem)
        }
        this.close()
      },
